...
def main(args):
    ...
    with open("wiktionary_unmarked_english_lexicon_quiz.json", "r") as json_file:
    ...
    with open(f"baseline_predictions/{args.model.replace('/', '-')}_predictions.json", "w") as json_file:
        for mcq in mcqs:
